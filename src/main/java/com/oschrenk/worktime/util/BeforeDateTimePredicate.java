 ...
 * @version $Id: $
 */
public class BeforeDateTimePredicate implements Predicate<Day> {

	private final DateTime dateTime;

	public BeforeDateTimePredicate(final DateTime dateTime) {
	...
	public boolean apply(final Day day) {
		if (day.getDay().isBefore(dateTime)) {
			return true;
		}
	...
	public String toString() {
		return "BeforeDateTimePredicate [dateTime=" + dateTime + "]";
	}
